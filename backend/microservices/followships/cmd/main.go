...
import (
	...
	"github.com/Archisman-Mridha/x-clone/backend/microservices/followships/internal/config"
	"github.com/Archisman-Mridha/x-clone/backend/microservices/followships/internal/constants"
	"github.com/Archisman-Mridha/x-clone/backend/microservices/followships/internal/followships"
...
func run(ctx context.Context, config *config.Config) error {
	...
	followshipsService := followships.NewFollowshipsService(
		followships.NewFollowshipsPostgresRepository(postgresConnector),
	)
	...
	followshipsAPI := followships.NewFollowshipsAPI(followshipsService)
	generated.RegisterFollowshipsAPIServer(gRPCServer, followshipsAPI)
