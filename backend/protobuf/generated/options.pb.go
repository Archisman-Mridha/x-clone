...
var file_grafbase_options_proto_rawDesc = string([]byte{
	...
	0x67, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x49, 0x73, 0x42, 0x0c, 0x5a, 0x0a, 0x67, 0x65, 0x6e, 0x65,
	0x72, 0x61, 0x74, 0x65, 0x64, 0x2f,
})

var (
	file_grafbase_options_proto_rawDescOnce sync.Once
	file_grafbase_options_proto_rawDescData []byte
)

func file_grafbase_options_proto_rawDescGZIP() []byte {
	file_grafbase_options_proto_rawDescOnce.Do(func() {
		file_grafbase_options_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_grafbase_options_proto_rawDesc), len(file_grafbase_options_proto_rawDesc)))
	})
	return file_grafbase_options_proto_rawDescData
}

var file_grafbase_options_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_grafbase_options_proto_goTypes = []any{
...
func file_grafbase_options_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_grafbase_options_proto_rawDesc), len(file_grafbase_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 19,
			NumServices:   0,
