...
//timoni:generate timoni mod vendor crd -f /tmp/kue/cluster-api-provider-aws/config/crd/bases/infrastructure.cluster.x-k8s.io_awsmachinetemplates.yaml
...
// AWSMachineTemplate is the schema for the Amazon EC2 Machine
// Templates API.
#AWSMachineTemplate: {
	...
	// AWSMachineTemplateSpec defines the desired state of
	// AWSMachineTemplate.
	spec!: #AWSMachineTemplateSpec
}
#AWSMachineTemplateSpec: {
	// AWSMachineTemplateResource describes the data needed to create
	// am AWSMachine from a template.
	template!: {
		...
		spec!: {
			...
			// ElasticIPPool is the configuration to allocate Public IPv4
			...
			// HostAffinity specifies the dedicated host affinity setting for
			// the instance.
			// When hostAffinity is set to host, an instance started onto a
			// specific host always restarts on the same host if stopped.
			// When hostAffinity is set to default, and you stop and restart
			// the instance, it can be restarted on any available host.
			// When HostAffinity is defined, HostID is required.
			hostAffinity?: "default" | "host"

			// HostID specifies the Dedicated Host on which the instance must
			// be started.
			hostID?: string
			...
			// InstanceMetadataOptions is the metadata options for the EC2
			// instance.
			...
			// NetworkInterfaceType is the interface type of the primary
			// network Interface.
			...
			// use for the node.
			// This is optional - if not provided security groups from the
