...
//timoni:generate timoni mod vendor crd -f /tmp/kue/cluster-api-provider-aws/config/crd/bases/infrastructure.cluster.x-k8s.io_awsmanagedmachinepools.yaml

package v1beta2

import "strings"

// AWSManagedMachinePool is the Schema for the
// awsmanagedmachinepools API.
#AWSManagedMachinePool: {
	...
	// AWSManagedMachinePoolSpec defines the desired state of
	// AWSManagedMachinePool.
...
#AWSManagedMachinePoolSpec: {
	...
	// AMIVersion defines the desired AMI release version. If no
	// version number
	// is supplied then the latest version for the Kubernetes version
	// will be used
	amiVersion?: strings.MinRunes(2)
	...
	// AWSLaunchTemplate specifies the launch template to use to
	// create the managed node group.
	// If AWSLaunchTemplate is specified, certain node group
	// configuraions outside of launch template
	// are prohibited
	...
	// CapacityType specifies the capacity type for the ASG behind
	// this pool
	...
	// AWSLifecycleHooks specifies lifecycle hooks for the managed
	// node group.
	lifecycleHooks?: [...{
	...
	remoteAccess?: {
		...
		// SourceSecurityGroups specifies which security groups are
		// allowed access
		sourceSecurityGroups?: [...string]

		// SSHKeyName specifies which EC2 SSH key can be used to access
		// machines.
	...
	// UpdateConfig holds the optional config to control the behaviour
	// of the update
	// to the nodegroup.
	updateConfig?: {
		// MaxUnavailable is the maximum number of nodes unavailable at
		// once during a version update.
		// Nodes will be updated in parallel. The maximum number is 100.
		maxUnavailable?: uint & >=1 & <=100

		// MaxUnavailablePercentage is the maximum percentage of nodes
		// unavailable during a version update. This
		// percentage of nodes will be updated in parallel, up to 100
		// nodes at once.
		maxUnavailablePercentage?: uint & >=1 & <=100
	}
}
