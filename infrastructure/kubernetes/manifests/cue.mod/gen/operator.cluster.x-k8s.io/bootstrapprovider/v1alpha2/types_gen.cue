...
//timoni:generate timoni mod vendor crd -f /tmp/kue/cluster-api-operator/config/crd/bases/operator.cluster.x-k8s.io_bootstrapproviders.yaml
...
#BootstrapProvider: {
	...
	// BootstrapProviderSpec defines the desired state of
	// BootstrapProvider.
	spec!: #BootstrapProviderSpec
}
