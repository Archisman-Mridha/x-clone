...
//timoni:generate timoni mod vendor crd -f /tmp/kue/cluster-api-operator/config/crd/bases/operator.cluster.x-k8s.io_controlplaneproviders.yaml

package v1alpha2

import "strings"

// ControlPlaneProvider is the Schema for the
// controlplaneproviders API.
#ControlPlaneProvider: {
	...
	// ControlPlaneProviderSpec defines the desired state of
	// ControlPlaneProvider.
	spec!: #ControlPlaneProviderSpec
}
