...
//timoni:generate timoni mod vendor crd -f /tmp/kue/cluster-api-operator/config/crd/bases/operator.cluster.x-k8s.io_runtimeextensionproviders.yaml

package v1alpha2

import "strings"

// RuntimeExtensionProvider is the Schema for the
// RuntimeExtensionProviders API.
#RuntimeExtensionProvider: {
	...
	// RuntimeExtensionProviderSpec defines the desired state of
	// RuntimeExtensionProvider.
	spec!: #RuntimeExtensionProviderSpec
}
