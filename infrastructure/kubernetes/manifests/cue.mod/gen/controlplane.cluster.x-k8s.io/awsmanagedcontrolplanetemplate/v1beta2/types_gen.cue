...
//timoni:generate timoni mod vendor crd -f /tmp/kue/cluster-api-provider-aws/config/crd/bases/controlplane.cluster.x-k8s.io_awsmanagedcontrolplanetemplates.yaml

package v1beta2

import "strings"

// AWSManagedControlPlaneTemplate is the Schema for the
// AWSManagedControlPlaneTemplates API.
#AWSManagedControlPlaneTemplate: {
	...
	// AWSManagedControlPlaneTemplateSpec defines the desired state of
	// AWSManagedControlPlaneTemplate.
