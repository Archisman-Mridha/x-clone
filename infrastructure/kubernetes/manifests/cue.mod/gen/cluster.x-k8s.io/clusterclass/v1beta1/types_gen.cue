...
#ClusterClassSpec: {
	...
	controlPlane?: {
		// machineHealthCheck defines a MachineHealthCheck for this
		// ControlPlaneClass.
	...
	patches?: list.MaxItems(1000) & [...{
		...
		definitions?: list.MaxItems(100) & [...{
			...
			selector!: {
				...
				apiVersion!: strings.MaxRunes(512) & strings.MinRunes(1)

				// kind filters templates by kind.
				kind!: strings.MaxRunes(256) & strings.MinRunes(1)
		...
		external?: {
			...
			// generateExtension references an extension which is called to
			// generate patches.
			generateExtension?: strings.MaxRunes(512) & strings.MinRunes(1)
			...
			// validateExtension references an extension which is called to
			// validate the topology.
			validateExtension?: strings.MaxRunes(512) & strings.MinRunes(1)
		}
	...
	variables?: list.MaxItems(1000) & [...{
		...
		// in the next apiVersion. Please use XMetadata in
		...
		schema!: {
			...
			openAPIV3Schema!: {
				...
				// NOTE: Can only be set if type is object.
				required?: list.MaxItems(1000) & [...strings.MaxRunes(256) & strings.MinRunes(1)]
