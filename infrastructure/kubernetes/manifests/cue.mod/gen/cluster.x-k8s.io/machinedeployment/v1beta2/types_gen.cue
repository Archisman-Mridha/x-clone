...
#MachineDeploymentSpec: {
	...
	// deletion contains configuration options for MachineDeployment
	// deletion.
	...
	// It allows you to require that all Machines are replaced after a
	// certain time,
	// and allows you to define the strategy used during rolling
	// replacements.
