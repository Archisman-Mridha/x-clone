...
//timoni:generate timoni mod vendor crd -f /tmp/kue/argo-cd/manifests/crds/appproject-crd.yaml
...
// whitelist/blacklist)
// * who can access these applications (roles, OIDC group claims
// bindings)
...
#AppProjectSpec: {
	...
	description?: strings.MaxRunes(255)
