...
//timoni:generate timoni mod vendor crd -f /tmp/kue/argo-cd/manifests/crds/application-crd.yaml
		...
		sync?: {
			...
			source?: {
				...
				kustomize?: {
					...
					// LabelIncludeTemplates specifies whether to apply common labels
					// to resource templates or not
